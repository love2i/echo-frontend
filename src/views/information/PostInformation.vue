  ...
  <div class="wrapper">
    <el-form ref="form" :model="form" label-position="top">
      ...
      <el-form-item label="发布">
        <el-button type="primary" @click="pubishInformation">确定发布</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
    ...
    methods: {
      pubishInformation() {
        if (!this.validateForm()) {
          // this.openMessage('请填写b字段', 'warning')
          return
        }
        let postData = {
      ...
      formatTime(date, time) {
        return '' + date.getFullYear() + '-' + date.getMonth() + '-' + date.getDay() + ' ' + time.getHours() + ':' + time.getMinutes() + ':' + time.getSeconds()
      }
    }
  }
</script>
